...
<!--
Potential review read: https://www.nature.com/articles/s41477-018-0210-1
beetle delimitation [Olave et al. 2023](https://ssbbulletin.org/index.php/bssb/article/view/9263)  
speciation: [Bock et al. 2023](https://www.cell.com/plant-communications/fulltext/S2590-3462(23)00110-4?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS2590346223001104%3Fshowall%3Dtrue)
cool grape stuff: https://www.pnas.org/doi/full/10.1073/pnas.2222041120
ploidy and extinction: [Soto-Gomez et al. 2024](https://nph.onlinelibrary.wiley.com/doi/full/10.1111/nph.19947)
spikelet [Ma et al. 2021](https://academic.oup.com/plcell/article/33/4/846/6119336?login=false)
sex chromosomes [Harkness et al. 2020](https://academic.oup.com/plcell/article/32/6/1790/6115597) 
|01 December | Macroevolution | The evolution of phtosynthesis systems and ecosystem change | TBD  |  class discussion  |
-->

<!--
Activity overview
1. simulations in msprime and life history effects on diversity
2. importance of experimental design
3. demystifying the sliding window
4. should we trust reconciliation?
5. models come from the heart
-->
...
|------------|------------|------------|------------|------------|
|23 October | Class Project       | Class Project 2: First Draft Due  |  NA       | [Project Guidelines]({{site.baseurl}}/projects)                                     |
|------------|------------|------------|------------|------------|
...
|05 November| Macroevolution | Comparative Methods: Evolution of Nodulation and Nitrogen Fixation | [Zhao et al. 2021](https://www.cell.com/molecular-plant/fulltext/S1674-2052(21)00072-1) | class discussion|
|06 November | Project (595) | 595 Research Proposal: First Draft Due | NA | [Project Guidelines]({{site.baseurl}}/projects) |
|10 November| Macroevolution |Plant Genome Architecture: Polyploidy-revisited | [Tang et al. 2008](https://www.science.org/doi/full/10.1126/science.1153917?casa_token=N3vFtNdHh7cAAAAA%3AZq79033kHGBNXmQtbiE0TIkeZK_eQMCK0CBxxLeHRq6vtVkbRv6Ghi4dLKMUcCY5tFJHMPOz_0ld7Q) | slides|
...
|------------|------------|------------|------------|------------|
|16 November   | Class Project | Class Project 3: Final, Print-Ready Draft Due    |  NA       | [Project Guidelines]({{site.baseurl}}/projects)                                      |
|------------|------------|------------|------------|------------|
...
|20 November | Project (595) | 595 Research Proposal: Peer Reviews Returned | NA | [Project Guidelines]({{site.baseurl}}/projects) |
|24 November | Macroevolution | Biogeographic Models | [Pérez-Escobar et. al. 2017](https://www.nature.com/articles/s41598-017-12300-y) | class discussion |
|26 November | No Class!       | Thanksgiving Holiday  |  NA       | NA                                    |
|------------|------------|------------|------------|------------|
|01 December | Class Project | Class Project 4: Presentations | NA  |  [Project Guidelines]({{site.baseurl}}/projects)     |    
|------------|------------|------------|------------|------------|
|03 December | Exams | Exam 3: Macroevolution (university final examination period) | NA  |  NA  |
|------------|------------|------------|------------|------------|
|04 December | Project (595) | 595 Research Proposal: Final Proposal Due | NA | [Project Guidelines]({{site.baseurl}}/projects) |
|------------|------------|------------|------------|------------|
                                                 
## Grading

Grading will consist of three exams, a class project, paper discussions, and computer activities. The class project will be a poster on an assigned clade and topic done in small groups. Guidance on poster projects is available on the [projects page]({{site.baseurl}}/projects/).
